...
async def _get_filesizes(
    ...
    async with aiohttp.ClientSession() as session:
        ...
        write_file_bytes(Path("dataset.json"), orjson.dumps(dataset))
        ...
        write_file_bytes(output_file, orjson.dumps(info))
...
def main(
    ...
    asyncio.run(_get_filesizes(dataset_name, output_file, api_key, limit))
