...
from paper.semantic_scholar.model import PaperFromPeerRead as PaperFromPeerRead
...
from paper.semantic_scholar.model import PeerReadWithFullS2 as PeerReadWithFullS2
